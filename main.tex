...
% Air traffic management systems generate vast amounts of operational data critical for optimizing airline operations, airport resource allocation, and passenger experience. However, access to this data is severely restricted due to commercial sensitivity, privacy regulations, and competitive considerations. Airlines often deem granular operational data "commercially sensitive and proprietary," fearing that sharing it could harm their competitive strategy \cite{majumder2025dgca}. Similarly, strict data protection laws, such as GDPR, and security concerns impose heavy restrictions on data sharing, creating a trade-off between openness and privacy \cite{lei2025fedmeta}. As a result, critical aviation datasets remain siloed, preventing external researchers and smaller stakeholders from obtaining rich historical data. This scarcity presents a practical challenge, as developing robust machine learning models for operational prediction requires comprehensive historical datasets that many organizations cannot access.

The aviation industry generates substantial operational data that could be valuable for optimizing flight operations, improving resource allocation, and enhancing passenger experience. However, access to this data is often restricted due to commercial sensitivity, privacy regulations, and competitive considerations. Airlines typically guard their operational data as commercially sensitive and proprietary, concerned that disclosure could affect their competitive strategies \cite{majumder2025dgca}. Additionally, data protection laws such as GDPR and security concerns create tensions between data openness and privacy protection \cite{lei2025fedmeta}. This limited access affects external researchers, smaller airlines, and emerging markets that lack the historical datasets needed for developing predictive analytics.

% Among the various predictive tasks in aviation, pre-tactical prediction—forecasting operational metrics hours to days before actual operations—exemplifies both the value and challenge of working with limited data access. Unlike tactical predictions made on the day of operations with real-time updates, pre-tactical models must rely solely on published schedules and historical patterns \cite{dalmau2024probabilistic}. This constraint makes pre-tactical prediction particularly sensitive to data availability: without access to comprehensive historical records showing how scheduled operations translated into actual performance, organizations cannot develop even baseline predictive capabilities. Yet these predictions provide crucial value across the aviation ecosystem. Airlines leverage pre-tactical forecasts to proactively adjust operations—swapping aircraft, reassigning crew, or modifying schedules to prevent disruptions before they cascade through the network \cite{mas2022pre}. Airports optimize resource allocation by anticipating gate requirements and staffing needs based on expected delays and turnaround times. For passengers, advance warning of likely delays enables informed decisions about connections and travel arrangements, reducing the impact of disruptions \cite{carvalho2021relevance}. The paradox is clear: those who could most benefit from pre-tactical predictions—smaller airlines, emerging markets, and academic researchers—are precisely those least likely to have access to the extensive historical datasets required to develop them.
...
% Recent advances in synthetic data generation offer a potential approach to addressing the data availability challenge. By creating artificial datasets that preserve the statistical properties of real operations while protecting sensitive information, synthetic data could enable broader access to advanced analytics capabilities. The Train on Synthetic, Test on Real (TSTR) \cite{esteban2017real} paradigm suggests that models trained exclusively on synthetic data can generalize to real-world scenarios, potentially allowing organizations without historical data access to develop operational prediction capabilities.
...
Using over 1.3 million European flight records, our analysis contributes:
\begin{itemize}
